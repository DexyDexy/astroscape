    ...
    const atmoMat = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          float lit = smoothstep(-0.12, 0.02, mu);           // пик свечения приходится на сам восход, а не до него
          ...
          float red = 1.0 - smoothstep(-0.04, 0.45, mu);
          float tail = exp(-pow((mu + 0.07) / 0.07, 2.0));   // пурпурный хвост в сторону ночи
