  ...
  NS.QUOTES = {
    ...
    body: {
      ...
      Moon: {
        ...
        9: { t: "This tends to bring the native before the public for good or evil, popularity or notoriety, though it usually has some drawback attaching to it.", s: "leo" },
        ...
        11: { t: "The native is quiet, retiring, and easy-going, is restless and fond of variety, easily changes his mind, is irresolute and not always to be depended upon, is rather easily discouraged, and meets with obstacles, misfortune and opposition in life.", s: "leo" },
      },
      Mercury: {
        ...
        5: { t: "Mercury in Virgo is at the zenith of his power for there he is exalted, consequently when well-aspected it gives a clear, logical, scientific mind, eloquence and the ability to express oneself fluently in a number of languages.", s: "heindel" },
      ...
      Venus: {
        0: { t: "Venus in Aries lends ardor to the affections of Venus by blending them with the fire of Mars who is ruler of Aries and for that reason it makes the person very ardent in the expression of affection.", s: "heindel" },
        1: { t: "Venus in Taurus are very set in their opinions concerning correct form and decorum, correct in speech and once they have formed an opinion they hold to it very tenaciously.", s: "heindel" },
        2: { t: "Venus in Gemini blends the beauty of Venus with the mercurial ability to express so that people who have this configuration are able to choose their words with singular facility and infuse in them a rhythm which is like music to the ears of a listener.", s: "heindel" },
        3: { t: "Venus in Cancer blends the characteristics of Venus with those of the Moon and the psychic watery nature of Cancer.", s: "heindel" },
        4: { t: "Venus in Leo is compounding love, for Leo rules the heart and whoever has this position will be tender-hearted to a degree.", s: "heindel" },
        5: { t: "Venus in Virgo, the Sixth House sign gives the person a deep and tender sympathy for the sick and people with this position make good nurses.", s: "heindel" },
        6: { t: "Venus in Libra, the Seventh House sign is essentially dignified and strong. This is one of the configurations which testify to a fruitful and congenial marriage or successful partnership.", s: "heindel" },
        8: { t: "Venus in Sagittarius. This is another of her strongest positions for there her qualities blend with those of Jupiter the planet of benevolence to foster love and good-will among men.", s: "heindel" },
        9: { t: "Venus in Capricorn, the Tenth House sign, gives social success and popularity, but Venus does not blend well with Saturn, the ruler of Capricorn.", s: "heindel" },
      },
      Mars: {
        ...
        5: { t: "Mars in Virgo when well-aspected gives an ambitious nature and a quick intellect, able to grasp an idea and elaborate upon it.", s: "heindel" },
      ...
      Jupiter: {
        ...
        3: { t: "Jupiter in Cancer makes the person very fond of the pleasures of the table but if well-aspected he will probably keep himself within such bounds that his health does not suffer.", s: "heindel" },
      ...
      Uranus: {
        ...
        11: { t: "Uranus in Pisces, when well-aspected indicates a love of the occult arts and ability of development along these lines.", s: "heindel" },
      },
      Neptune: {
