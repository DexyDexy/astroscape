...
(function (NS) {
  ...
  const ru = {
    ...
    ui: {
      ...
      // подписи в 3D
      equator: 'небесный экватор', aries: '♈ 0° · точка весеннего равноденствия', noonMark: '☉ полдень', zenith: 'зенит', sunLabel: '☉ Солнце',
    },
    help: [
  ...
  const en = {
    ...
    ui: {
      ...
      equator: 'celestial equator', aries: '♈ 0° · vernal equinox point', noonMark: '☉ noon', zenith: 'zenith', sunLabel: '☉ Sun',
    },
    help: [
