...
(function (NS) {
  ...
  const ru = {
    ...
    ui: {
      ...
      btnSky: '✧ Небо', btnSkyTitle: 'Небо из выбранной точки: настоящее небо, как его видно с Земли (V)', skyToast: 'Небо из выбранной точки. Тяните мышью, чтобы осмотреться, колесо — приближение', hintSky: 'небо из точки наблюдения', uiToggle: 'Показать / скрыть панели',
      situation: 'Обстановка', ascendant: 'Асцендент', midheaven: 'Середина неба', dayRuler: 'Управитель дня', hourRuler: 'Управитель часа',
      reading: 'Толкование',
      ...
      dignShort: { domicile: 'об', exalt: 'экз', detriment: 'изг', fall: 'пад' },
    ...
    help: [
      ...
      '<b>Кольца</b> — орбиты как на астрологической карте: каждая планета стоит на своём кольце под своей эклиптической долготой. Стебелёк вверх/вниз — эклиптическая широта.',
      '<b>Небо отсюда</b> (кнопка «Небо», клавиша V) — настоящее небо из выбранной точки: светила и звёзды стоят на своих реальных местах, ниже горизонта — затемнение. Размеры светил условные. Тяните мышью, чтобы осмотреться, колесо — приближение.',
  ...
  const en = {
    ...
    ui: {
      ...
      btnSky: '✧ Sky', btnSkyTitle: 'Sky from the chosen place: the real sky as seen from Earth (V)', skyToast: 'Sky from your place. Drag to look around, scroll to zoom', hintSky: 'sky from the observer', uiToggle: 'Show / hide panels',
      situation: 'Situation', ascendant: 'Ascendant', midheaven: 'Midheaven', dayRuler: 'Ruler of the day', hourRuler: 'Ruler of the hour',
      reading: 'Reading',
      ...
      dignShort: { domicile: 'dom', exalt: 'exa', detriment: 'det', fall: 'fall' },
    ...
    help: [
      ...
      '<b>Rings</b> — orbits as on an astrological chart: each planet sits on its own ring at its ecliptic longitude. The stem up/down is ecliptic latitude.',
      '<b>Sky from here</b> (“Sky” button, V key) — the real sky from the chosen place: the Sun, Moon, planets and stars are at their true positions, everything below the horizon is dimmed. Body sizes are schematic. Drag to look around, scroll to zoom.',
